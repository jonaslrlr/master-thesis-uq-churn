...
from thesis_uq.data.cell2cell import load_cell2cell_csv, encode_tabular_for_tabnet
...
# Fixed training params (same as telco baseline)
FIXED = dict(
    gamma=1.5,
    lr=2e-2,
    weight_decay=1e-5,
...
def main():
    ...
    print("Pos rates:", y_train.mean(), y_valid.mean(), y_test.mean())
